<div class="container-fluid">
    ...
    <?php foreach ($manage_account as $acc) : ?>
        ...
        ?>
        <form action="<?= base_url() . 'super_admin/manage_account/update_account' ?>" method="post">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="<?= base_url('super_admin/manage_account') ?>" class="btn btn-danger font-weight-bold float-right" id="btnCancel"><i class="fas fa-times"></i> Cancel</a>
