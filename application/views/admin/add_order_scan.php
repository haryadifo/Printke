...
<h2 class="mt-4 mb-3">Tambah Orderan Scan</h2>
    <form action="<?= base_url() . 'admin/order_scan/add_order_scan' ?>" id="invoice_form" method="post">
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="<?= base_url('admin/order_scan/index');?>" class="btn btn-danger font-weight-bold float-right" id="btnCancel"><i class="fas fa-times"></i> Cancel</a>
                </div>
            </div>
        </form>
    </div>
