...
<h2 class="mt-4 mb-3">Tambah Orderan Print</h2>
    <form action="<?= base_url() . 'admin/order_print/add_order_print' ?>" id="invoice_form" method="post">
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="<?= base_url('admin/order_print/index');?>" class="btn btn-danger font-weight-bold float-right" id="btnCancel"><i class="fas fa-times"></i> Cancel</a>
                </div>
            </div>
        </form>
    </div>
