...
<h2 class="mt-4 mb-3">Tambah Akun</h2>
    <form action="<?= base_url() . 'admin/manage_account/add_admin' ?>" id="invoice_form" method="post">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="<?= base_url('admin/manage_account/index');?>" class="btn btn-danger font-weight-bold float-right" id="btnCancel"><i class="fas fa-times"></i> Cancel</a>
                </div>
            </div>
        </form>
    </div>
