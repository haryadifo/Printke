...
<body>
    ...
    <body>
        <div class="container-fluid">
            <form action="<?= base_url() . 'users/order_jilid/add_order_jilid' ?>" id="invoice_form" method="post">
                <div class="form-group">
                    <font size="+2"><label>Ukuran Kertas</label></font>
                    <select name="ukuran_kertas" id="role" class="custom-select">
                    <font size="+2"><option value="A4">A4</option></font>
                    <font size="+2"><option value="F4">F4</option></font>
                    <font size="+2"><option value="Legal">Legal</option></font>
                    <font size="+2"><option value="Letter">Letter</option></font>
                    </select>
                </div>  
                <div class="form-group">
                <font size="+2"><label>Warna Kertas Kambing</label></font>
                    <select name="warna_kamb" id="role" class="custom-select">
                    <font size="+2"><option value="Kuning">Kuning</option></font>
                    <font size="+2"><option value="Merah">Merah</option></font>
                    <font size="+2"><option value="Hijau">Hijau</option></font>
                    <font size="+2"><option value="Biru">Biru</option></font>
                    </select>
                </div>  
                <div class="form-group">
                ...
                <div class="form-group">
                <font size="+2"><label>File Jilid</label>
