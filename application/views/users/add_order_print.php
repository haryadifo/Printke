...
<body>
    ...
    <body>
        <div class="container-fluid">
            <form action="<?= base_url() . 'users/order_print/add_order_print' ?>" id="invoice_form" method="post">
            <div class="form-group">
                <font size="+2"><label>File Print</label>
            ...
            <div class="form-group">
                <font size="+2"><label>Jenis Tinta</label>
